          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: Text(
                  "This Privacy Policy (“Privacy Policy”), is an integral part of our End User License Agreement (“EULA”), and governs the processing and transfer of personal data collected or processed by using or accessing Cleanup and Speedup mobile application (“we”, “us” or “our”) or our services, all as detailed in the applicable EULA (respectively the “App” and “Service”).",
            ...
            Row(
              children: [
                Expanded(
                    child: Text(
                        "If you have any questions regarding this Privacy Policy or our data practices, you are welcome to contact us at: support.cleanupandspeedup@zipoapps.com"))
              ],
            ),
          ],
        )),
